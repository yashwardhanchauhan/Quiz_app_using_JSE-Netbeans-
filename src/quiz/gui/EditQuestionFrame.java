...
public class EditQuestionFrame extends javax.swing.JFrame {
     ...
     public EditQuestionFrame(ExamPojo exam)
    {
        this();
        this.exam=exam;
        System.out.println("newexam is:"+this.exam);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jcCorrectOption, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(51, 51, 51))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(116, 116, 116)
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        QuestionsPojo obj=new QuestionsPojo(exam.getExamId(),qno,question,option1,option2,option3,option4,optionName,exam.getLanguage());
        qstore.addQuestion(obj);
        lblTitle.setText((exam.getTotalQuestions()-qno)+" Questionn Remaining");
        qno++;
    ...
    private void btnDoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoneActionPerformed
        ...
        if(qno<=exam.getTotalQuestions())
        {
            ...
            int remainingQuestions=exam.getTotalQuestions()-qno+1;
